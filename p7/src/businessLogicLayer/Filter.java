...
public class Filter {
    ...
    public static Map<String, Integer> countOccurrences(TweetStorage tweets) {
        ...
        int foodPoison = 0, sick = 0, ill = 0, stomachFlue = 0, diarrhea = 0, dehydration = 0, salmonella = 0, nausea = 0,
        ...
        for (int i = tweets.size() - 1; i >= 0; i--) {
            ...
            counters.put("food poison", foodPoison);
    ...
    private static Map<String, String> getRegularExpressions() {
        ...
        regs.put("food poison", "fo(od|d|ood|ods|odd)\\s?poi(son|sons|sen|sens|sn)");
    ...
    public static Map<String, Integer> alternativeCountOccurrences(TweetStorage tweets) {
        Map<String, Integer> counters = new HashMap<String, Integer>();
        Map<String, String> regularExpressions = getRegularExpressions();
            ...
            for (Map.Entry<String, String> entry : regularExpressions.entrySet()) {
                ...
                if (m.find()) {
                    for (Map.Entry<String, Integer> counterEntry : counters.entrySet()) {
                        if (key.equals(counterEntry.getKey())) {
                            counters.put(key, counterEntry.getValue() + 1);
                        }
                    }
                }
            }
